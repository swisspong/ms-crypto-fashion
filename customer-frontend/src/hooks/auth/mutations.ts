import { signin, signinMetamask, signout, signup } from "@/src/services/auth.service";
import { useMutation, useQueryClient } from "@tanstack/react-query";
export const useSigninMetamask = () => {
    const queryClient = useQueryClient();
    return useMutation(
        (body: ISigninMetamaskPayload) => signinMetamask(body),
        {
